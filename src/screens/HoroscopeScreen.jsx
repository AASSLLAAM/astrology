      ...
      <div className="relative w-full h-full flex flex-col">
        ...
        <div className="p-6 mt-14 flex-1 overflow-y-auto custom-scrollbar">
          <div className="text-center mb-8">
            <h2 className="text-xl font-bold text-white mb-2">{t('horoscope.subtitle')}</h2>
            {user?.zodiacSign && (
              <div 
              ...
              >
                ...
                <span className="text-sm font-bold text-white">{t('horoscope.yourSign')}: {user.zodiacSign.name}</span>
                <span>➔</span>
              </div>
            )}
          </div>
