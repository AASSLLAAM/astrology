...
import { buildPalmSummary } from '../utils/palmLineDescriptions';
import { HANDS, SCREENS } from '../../utils/constants';
...
const PalmScanScreen = () => {
  ...
  const handleScanComplete = async (base64Image) => {
    ...
    try {
      ...
      // 1. Analyze image structure (Vision API)
      ...
      // 3. Get detailed AI interpretation (Text API)
      ...
      hideLoading();
      showError(t('errors.image')); // Fallback error message
